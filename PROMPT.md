...
### Core Requirements:
1. **Frontend:** Use React (Vite) with Tailwind CSS and Framer Motion for animations. Follow a 'Hardware Specialist Tool' aesthetic (dark mode, high-density data, monospace fonts for values).
